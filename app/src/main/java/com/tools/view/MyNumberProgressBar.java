 ...
 * 可以动态设置 也可以在xml中设置
 */
public class MyNumberProgressBar extends View {
    ...
    public MyNumberProgressBar(Context context) {
        this(context, null);
    }

    public MyNumberProgressBar(Context context, AttributeSet attrs) {
        this(context, attrs, R.style.MyNumberProgressBarDefault);
    }

    public MyNumberProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        final TypedArray attributes = context.getTheme().obtainStyledAttributes(attrs, R.styleable.MyNumberProgressBar, defStyleAttr, 0);

        mReachedBarColor = attributes.getColor(
                R.styleable.MyNumberProgressBar_progress_reached_color,
                default_reached_color);
        mUnreachedBarColor = attributes.getColor(
                R.styleable.MyNumberProgressBar_progress_unreached_color,
                default_unreached_color);
        mTextColor = attributes.getColor(
                R.styleable.MyNumberProgressBar_progress_text_color,
                default_text_color);
        mTextSize = attributes.getDimension(
                R.styleable.MyNumberProgressBar_progress_text_size,
                default_text_size);

        mReachedBarHeight = attributes.getDimension(
                R.styleable.MyNumberProgressBar_progress_reached_bar_height,
                default_reached_bar_height);
        mUnreachedBarHeight = attributes.getDimension(
                R.styleable.MyNumberProgressBar_progress_unreached_bar_height,
                default_unreached_bar_height);
        mOffset = attributes.getDimension(
                R.styleable.MyNumberProgressBar_progress_text_offset,
                default_progress_text_offset);

        int textVisible = attributes.getInt(
                R.styleable.MyNumberProgressBar_progress_text_visibility,
        ...
        setProgress(attributes
                .getInt(R.styleable.MyNumberProgressBar_progress, 0));
        setMax(attributes.getInt(R.styleable.MyNumberProgressBar_max, 100));
